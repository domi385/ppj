...
public class RuleUtility {
	...
	private static boolean checkFunctionDeclarations(Environment globalEnvironment) {
		...
		for (Environment env : environments) {
			Set<Environment.FunctionTableEntry> functions = new HashSet<>(env.getFunctionsTable().values());
	...
	private static boolean checkMain(Environment globalEnvironment) {
		...
		return Environment.checkFunctionDeclaration(globalEnvironment, "main", Types.INT, parameterTypes)
