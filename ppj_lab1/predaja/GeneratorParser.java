...
/**
 * Razred koji parsira datoteku s pravilima potrebnim za generiranje leksickog
 * analizatora.
 *
 * @author Dominik
 */
public class GeneratorParser {
    ...
    /**
     * Izraz koji predstavlja leksicku jedinku
     */
    private static final Pattern TOKEN = Pattern.compile("\\w+");
    /**
     * Pocetni redak zadanog pravila
     */
     ...
     * @param regex
     *            procitani regex
     * @return "cisti regex" - bez imena regularnih definicija u njemu
     */
